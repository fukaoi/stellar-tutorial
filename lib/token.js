...
module.exports = class Token {
  ...
  async addOperation() {
    ...
    ////////// Revoke ////////
    // const operation = StellarSdk.Operation.setOptions({setFlags: StellarSdk.AuthRevocableFlag | StellarSdk.AuthRequiredFlag})

    ///////// Permis ////////
    const operation = StellarSdk.Operation.setOptions({setFlags: 0})
